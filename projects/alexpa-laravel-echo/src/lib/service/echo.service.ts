...
export class EchoService {
  ...
  constructor(private ngZone: NgZone,
    ...
    this.connected$ = (this.connectionState$ as Observable<SocketIoConnectionEvents>).pipe(
      map(() => this.connected),
   ...
   * @param headers Optional Authentication headers to send when talking to the service
   * @returns The instance for chaining
   */
  login(userId: string | number, headers?: { [key: string]: string }): EchoService {
